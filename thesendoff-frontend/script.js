    ...
    if (document.body.classList.contains('news-app-page')) {
        ...
        if (sendPromptBtn) {
            sendPromptBtn.addEventListener('click', async () => {
                ...
                try {
                    // This is the FIXED fetch call. It sends the prompt to your Netlify function.
                    ...
                    geminiResponseDisplay.innerHTML = `<p class="text-red-500">An error occurred while connecting to the server. Please check your Netlify logs.</p>`;
                } finally {
